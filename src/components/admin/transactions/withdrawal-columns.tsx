...
import { useAccount, type Withdrawal } from "@/contexts/account-context";
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            {withdrawal.status === 'pending' && (
              <>
                <DropdownMenuItem onClick={() => updateWithdrawalStatus(withdrawal.id, 'completed')}>Approve</DropdownMenuItem>
                <DropdownMenuItem onClick={() => updateWithdrawalStatus(withdrawal.id, 'cancelled')}>Decline</DropdownMenuItem>
              </>
            )}
          </DropdownMenuContent>
        </DropdownMenu>
